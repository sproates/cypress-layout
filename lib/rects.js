// the rect returned by el.getBoundingClientRect() isn't writable. This produces
// a facsimile of the rect that is.
...
function getRect(subject) {
  let element;
  if (subject == null) {
    throw new Error(`Expected to find element: '${subject}', but never found it.`);
  } else if (typeof subject === 'string') { // the selector passed in to thre assertion
